...
@section('title', 'Register | Hens Care')
        ...
        <div class="card border border-light-subtle rounded-3 shadow-sm">
          <div class="card-body p-3 p-md-4 p-xl-5">
            <div class="text-center mb-3">
              <a href="#!">
                <img src="images/ayam1.png" alt="Hens Care" width="250">
              </a>
            </div>
...
<div class="row gy-2 overflow-hidden">
    ...
    <div class="col-12">
        <div class="form-floating mb-3">
            <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror"
                name="password_confirmation" id="password_confirmation" value="" placeholder="password_confirmation"
                required>
    ...
    <div class="col-12">
        <p class="m-0 text-secondary text-center">Have an account? <a href="{{ route('login') }}"
      ...
      <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
        <div class="card border border-light-subtle rounded-3 shadow-sm mt-5">
          <div class="card-body p-3 p-md-4 p-xl-5">
            <div class="text-center mb-3">
              <a href="#!">
                <img src="{{ asset('images/ayam1.png') }}" alt="Hens Care" width="250">
</a>
</div>
...
<form method="POST" action="{{ route('register.post') }}">
    ...
    <div class="row gy-2 overflow-hidden">
        ...
        <div class="col-12 text-center">
            <p class="m-0 text-secondary">Already have an account?
...
<head>
    ...
    <title>Silahkan Buat Akun Anda Terlebih Dahulu</title>
